...
namespace lab_entity_framework_core_data_annotations
{
    internal class Program
    {
        // Criação do contexto
        public static ApplicationContextDataAnnotations db = new ApplicationContextDataAnnotations();
        ...
        public static void RemoveRegistrosDesconectado()
        {
            ...
            try
            {
                ...
                using (var context = new ApplicationContextDataAnnotations())
                {
                    // Várias formas de remover pessoas
